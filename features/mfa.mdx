...
<Accordion title="Invalid verification code">
  ...
  **Solution:**
  ...
  - Wait for new code and enter quickly
  - Try backup code if persistent
</Accordion>
...
<Accordion title="QR code not scanning">
  ...
  **Solution:**
  ...
  - Enter: Account = email, Issuer = Vritti
  - Copy secret key from display
</Accordion>
...
<Accordion title="SMS code not received">
  ...
  **Solution:**
  - Wait 30 seconds and resend
  - Check phone verification status
  - Use TOTP or passkey instead
</Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Onboarding Flow" icon="list-check" href="/features/onboarding/flow-overview">
    MFA setup is part of user onboarding
  </Card>
</CardGroup>
