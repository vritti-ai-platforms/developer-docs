...
<CardGroup cols={2}>
  <Card title="MFA" icon="shield-check" href="/features/mfa">
    Passkeys can be used as second factor
  </Card>
  <Card title="JWT Sessions" icon="key" href="/features/auth/jwt-sessions">
    Passkey login creates standard session tokens
  </Card>
  ...
  <Card title="CSRF Protection" icon="lock" href="/features/csrf">
    Uses same HMAC key for OAuth state signing
  </Card>
</CardGroup>
